...
public class fuel1 : MonoBehaviour 
{
    ...
    [Header("SO")]
    [SerializeField] private FloatContainer m_fuelContainer;//今の燃料とかいろいろ

    [Header("Fuel Settings")]
    [SerializeField] private float m_consumptionRate = 1f;//継続消費
    [SerializeField] private float m_boostFuelCost = 10f;//ブーストなど
    ...
    void Update()
    {
        ...
        //移動
        //多分機体が移動じゃなくてゴミとかが向かってくるタイプだからコメントアウトしていたと思いますのでまたしてくださいこちらのテストで外してると思うので
        Move();
