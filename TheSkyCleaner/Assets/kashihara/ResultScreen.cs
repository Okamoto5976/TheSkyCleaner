...
public class ResultScreen : MonoBehaviour
{
    ...
    [SerializeField] private List<TextMeshProUGUI> m_text;
    ...
    private int m_score;
    public int[] m_enhanceLevel = new int[(int)SkillType.Count];//スキルの種類ごとに箱をつくり
                                                                 //それぞれ何レベル強化したか
    ...
    public void Result()
    {
        ...
        m_text[2].text = m_enhanceLevel[0].ToString();
        m_text[3].text = m_enhanceLevel[1].ToString();
        m_text[4].text = m_enhanceLevel[2].ToString();
        m_text[5].text = m_enhanceLevel[3].ToString();
        m_text[6].text = m_enhanceLevel[4].ToString();
        m_text[7].text = m_enhanceLevel[0].ToString();
    }
